...
ALERT_PATTERNS: tuple[AlertPattern, ...] = (
    AlertPattern("halogen", "[F,Cl,Br,I]", "할로겐은 lipophilicity와 hERG liability를 높일 수 있습니다."),
    ...
    AlertPattern("basic_amine", "[NX3;H2,H1,H0;!$(NC=O)]", "염기성 amine은 BBB 통과와 hERG risk에 영향을 줄 수 있습니다."),
